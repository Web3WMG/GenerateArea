...
<body class="border-top-wide border-primary d-flex flex-column theme-<?= get_cookie('theme') ?? 'light' ?>">
	<div class="page page-center">
		<div class="container text-center">
			<div class="empty">
				<div class="empty-header"><img src="<?= base_url() ?>assets/<?= $this->base->get_template() ?>/img/xera.png" alt="GenerateArea logo" class="img-fluid"></div>
				<p class="empty-title">Version <?= get_version() ?></p>
				<p class="empty-subtitle text-muted">
					You are using the latest version of GenerateArea.
				</p>
			</div>
		</div>
	</div>
