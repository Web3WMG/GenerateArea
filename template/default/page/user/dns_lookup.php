		...
		<div class="card-body">
			<form action="<?= base_url() ?>u/dns_lookup" method="GET">
				<div class="mb-0">
					<div class="row">
						<div class="col-md-6">
							<input type="text" name="domain" class="form-control mb-2" placeholder="<?= $this->base->text('domain_name', 'label') ?>" value="<?php if ($this->input->get('domain') !== false): echo(strtolower(htmlspecialchars($this->input->get('domain'))));endif ?>" required>
						</div>
						<div class="col-md-6">
